...
router.post('/', express.json(), celebrate(createBucketValidation, defaultSchemaOptions), errorWrapper(createBucketRoute));
router.put('/:id', express.json(), celebrate(updateBucketValidation, defaultSchemaOptions), errorWrapper(updateBucketRoute));
...
router.delete(
  '/:id/videos/:videoId/questions/:questionId',
  errorWrapper(deleteQuestionRoute),
);
...
router.delete(
  '/:id/videos/:videoId/questions/:questionId/answer',
  errorWrapper(deleteAnswerRoute),
);

router.get(
  '/:id/videos/:videoId/polls',
  errorWrapper(getPollsListRoute),
);
router.post(
  '/:id/videos/:videoId/polls',
  express.json(),
...
router.delete(
  '/:id/videos/:videoId/polls/:pollId/answer',
  errorWrapper(deletePollAnswerRoute),
);
